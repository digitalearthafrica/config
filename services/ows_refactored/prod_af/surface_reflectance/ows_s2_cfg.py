from prod_af.surface_reflectance.style_sr_cfg import styles_s2_list
from prod_af.ows_reslim_cfg import reslim_srtm
from prod_af.surface_reflectance.band_sr_cfg import bands_sentinel
