from prod_af.ows_reslim_cfg import reslim_sentinel2, reslim_srtm
from prod_af.surface_reflectance.style_sr_cfg import (
    styles_ls8c_list,
    styles_gm_list,
    styles_tmads_list,
)
from prod_af.surface_reflectance.band_sr_cfg import bands_s2_gm, bands_ls8c
