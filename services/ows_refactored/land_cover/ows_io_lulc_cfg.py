...
The global map was produced by applying this model to the Sentinel-2 2020 scene collection on the Planetary Computer. For more information, see https://planetarycomputer.microsoft.com/dataset/io-lulc.
""",
